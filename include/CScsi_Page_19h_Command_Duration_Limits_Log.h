...
#pragma pack(pop)
        ...
        void process_Generic_Data(JSONNODE* genericData, uint16_t paramCode, uint32_t offset);
        void process_Achievable_Data(JSONNODE * achievableData, uint16_t paramCode, uint32_t offset);
        void process_Duration_Limits_Data(JSONNODE* limitData, uint32_t offset);
