...
[![Build Status](https://travis-ci.org/Seagate/opensea-parser.svg?branch=master)](https://travis-ci.org/Seagate/opensea-parser)
...
openSeaChest_LogParser project repository is maintained at
https://github.com/Seagate/openSeaChest_LogParser.

### opensea-parser
Cross platform library containing common set of functions to parse various
binary data logs from storage devices to human readable formats.

#### Overview

The opensea-parser library has common set of defines and functions
that allow upper layers to send  

#### Source

https://github.com/Seagate/opensea-parser.git

#### Building

opensea-parser depends on the opensea-common library and the two should
...
To build under Microsoft Windows, open the corresponding
Visual Studio Solution files for VS 2013 or 2017
